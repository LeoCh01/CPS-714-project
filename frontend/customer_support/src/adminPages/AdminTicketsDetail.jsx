...
const submitTicket = (e) => {//Make ticket_response_id=ticket_id?, add tickets_ticket, get user_id
  const ticketPost = {ticket_response_id: 5, user_id:"admin", response_text:ticketResText, responded_at:"2024-11-13"};

  fetch(`http://127.0.0.1:8000/base/tickets/response`, {
    method: 'POST',
